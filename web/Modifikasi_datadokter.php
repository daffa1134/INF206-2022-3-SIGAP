...
<head>
	...
	<title>Modifikasi Informasi Dokter</title>
...
<body>
 <!-- Wrapper -->
    <div class="wrapper">
        ...
        <div class="col-md-6">
            <h3>Rumah Sakit Dr. Aminah Seodarso</h3>
            <strong>Informasi Dokter</strong><br>
            ...
            <table class="table table-user-information">
                <tbody>
                    ...
                    <tr>        
                        ...
                        <td class="form-group">
                            <input type="text" class="form-control" id="Spesialis" placeholder="Masukkan Speasialis"> 
                        </td>
                    </tr>
                    <tr>        
                        <td>
                        ...
                        <td class="form-group">
                            <input type="text" class="form-control" id="Jam Kerja" placeholder="Masukkan Jam Kerja"> 
                        </td>
                    </tr>
                    <tr>        
                        <td>
