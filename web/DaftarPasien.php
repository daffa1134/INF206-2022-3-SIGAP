...
<body>
	<div class="container">
		<form action="" method="POST" class="daftar-form">
			...
			<div class="input-group"><input type="text" placeholder="Nama Lengkap" name="nama_lengkap" value="<?php echo $nama_lengkap; ?>"></div>
			<div class="input-group"><input type="text" placeholder="E-mail" name="email" value="<?php echo $email; ?>"></div>
			<div class="input-group"><input type="password" placeholder="Password" name="password" value="<?php echo $_POST["password"]; ?>"></div>
			<div class="input-group"><input type="password" placeholder="Konfirmasi Password" name="cpassword" value="<?php echo $_POST["cpassword"]; ?>"></div>
