...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="container bg-light mt-3" style="border-radius: 15px; padding: 30px; font-family: 'Roboto', sans-serif;">
            <h2>Apotek Laris</h2><hr>
            <div class="row">
                <div class="col-md-4">
                    <form action="" method="POST">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Cari Spesialis..." autocomplete="off" autofocus>
                        <input class="btn btn-success" type="submit" name="Cari">
                    </div>
                    </form>
                </div>
            </div>
